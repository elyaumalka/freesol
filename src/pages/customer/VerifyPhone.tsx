      ...
      <div className="flex items-center justify-center lg:justify-end p-6 lg:p-12 w-full min-h-screen">
        ...
        >
          ...
          <p 
            ...
            style={{ fontFamily: 'Discovery_Fs' }}
          >
            הזינו את כמספר הטלפון איתו נרשמתם<br />
            למערכת.
          </p>
          ...
          <form onSubmit={handleVerify} className="space-y-4 lg:space-y-6">
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <Phone className="absolute right-4 lg:right-5 top-1/2 -translate-y-1/2 h-5 w-5 lg:h-6 lg:w-6 text-[#FFBF66]" />
            </div>
            ...
            >
              ...
              {isLoading ? 'מאמת...' : 'אימות מספר הטלפון ←'}
            </button>
