...
interface NewProjectStep4Props {
...
export function NewProjectStep4({ projectData, updateProjectData, onNext, onBack }: NewProjectStep4Props) {
      ...
      >
        ...
        <div className="flex-1 text-right pr-4">
          {projectData.uploadedFile ? (
            ...
            <p className="text-[22px] font-bold text-[#742551]" style={{ fontFamily: 'Discovery_Fs' }}>
              לחצו להוספת  קובץ פלייבק מהמחשב
            </p>
          )}
        </div>
      </div>
